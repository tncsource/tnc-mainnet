...
)
{
   ...
   sigmaengine::chain::public_key_type debug_public_key;
   if( debug_key != "" )
   {
   ...
   while( produced < count )
   {
      ...
      sigmaengine::chain::public_key_type scheduled_key = scheduled_bobserver.signing_key;
      if( debug_key != "" )
      {
...
SIGMAENGINE_DEFINE_PLUGIN( debug_node, sigmaengine::plugin::debug_node::debug_node_plugin )
