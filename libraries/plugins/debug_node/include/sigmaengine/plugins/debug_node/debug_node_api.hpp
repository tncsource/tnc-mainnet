...
{
   public:
      debug_node_api( const sigmaengine::app::api_context& ctx );
       ...
       */
      // not implemented
      //void debug_push_block( sigmaengine::chain::signed_block& block );
...
FC_REFLECT( sigmaengine::plugin::debug_node::get_dev_key_args,
   (name)
   )

FC_REFLECT( sigmaengine::plugin::debug_node::get_dev_key_result,
   (private_key)
   (public_key)
   )

FC_API(sigmaengine::plugin::debug_node::debug_node_api,
       (debug_push_blocks)
