...
FC_REFLECT( sigmaengine::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( sigmaengine::account_by_key::key_lookup_object, sigmaengine::account_by_key::key_lookup_index )
