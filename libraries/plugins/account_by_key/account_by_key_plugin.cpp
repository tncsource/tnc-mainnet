#include <sigmaengine/account_by_key/account_by_key_plugin.hpp>
...
account_by_key_plugin::account_by_key_plugin( sigmaengine::app::application* app )
...
SIGMAENGINE_DEFINE_PLUGIN( account_by_key, sigmaengine::account_by_key::account_by_key_plugin )
