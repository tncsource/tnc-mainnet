...
#include <sigmaengine/plugins/auth_util/auth_util_api.hpp>
#include <sigmaengine/plugins/auth_util/auth_util_plugin.hpp>
...
{
   public:
      auth_util_api_impl( sigmaengine::app::application& _app );
      void check_authority_signature( const check_authority_signature_params& args, check_authority_signature_result& result );

      std::shared_ptr< sigmaengine::plugin::auth_util::auth_util_plugin > get_plugin();

      sigmaengine::app::application& app;
};

auth_util_api_impl::auth_util_api_impl( sigmaengine::app::application& _app ) : app( _app )
{}

std::shared_ptr< sigmaengine::plugin::auth_util::auth_util_plugin > auth_util_api_impl::get_plugin()
{
...
auth_util_api::auth_util_api( const sigmaengine::app::api_context& ctx )
{
