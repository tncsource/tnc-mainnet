...
typedef fixed_string< fc::erpair< fc::erpair< fc::uint128_t, fc::uint128_t >, fc::erpair< fc::uint128_t, fc::uint128_t > > >  fixed_string_64;
...
namespace fc { namespace raw {
   ...
   inline void pack( Stream& s, const sigmaengine::protocol::fixed_string< Storage >& u )
   {
      pack( s, std::string( u ) );
   }

   template< typename Stream, typename Storage >
   inline void unpack( Stream& s, sigmaengine::protocol::fixed_string< Storage >& u )
   {
      std::string str;
      unpack( s, str );
      u = str;
   ...
   void to_variant(   const sigmaengine::protocol::fixed_string< Storage >& s, variant& v ) { v = std::string( s ); }

   template< typename Storage >
   void from_variant( const variant& v, sigmaengine::protocol::fixed_string< Storage >& s ) { s = v.as_string(); }
} // fc
