...
#require '/cygdrive/d/40_VC_Project/sigmaengine/build/libraries/wallet/doxygen/perlmod/DoxyDocs.pm';
...
{
  if ($class->{name} eq 'sigmaengine::wallet::wallet_api')
  {
...
} } // end namespace sigmaengine::wallet
END
