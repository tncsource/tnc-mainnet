...
FC_REFLECT( sigmaengine::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( sigmaengine::chain::block_summary_object, sigmaengine::chain::block_summary_index )
