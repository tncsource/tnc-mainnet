...
namespace sigmaengine { namespace chain {
   ...
   using sigmaengine::protocol::weight_type;
...
FC_REFLECT_TYPENAME( sigmaengine::chain::shared_authority::account_authority_map)
FC_REFLECT( sigmaengine::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
