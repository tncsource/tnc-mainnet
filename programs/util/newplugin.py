...
target_link_libraries( {plugin_provider}_{plugin_name} sigmaengine_app sigmaengine_chain sigmaengine_protocol )
...
{{
   public:
      {plugin_name}_api( const sigmaengine::app::api_context& ctx );
...
class {plugin_name}_plugin : public sigmaengine::app::plugin
{{
   public:
      {plugin_name}_plugin( sigmaengine::app::application* app );
...
{{
   public:
      {plugin_name}_api_impl( sigmaengine::app::application& _app );
...
{plugin_name}_api_impl::{plugin_name}_api_impl( sigmaengine::app::application& _app ) : app( _app )
{{}}
...
{plugin_name}_api::{plugin_name}_api( const sigmaengine::app::api_context& ctx )
{{
...
{{
   public:
      {plugin_name}_plugin_impl( sigmaengine::app::application& app );
...
{plugin_name}_plugin_impl::{plugin_name}_plugin_impl( sigmaengine::app::application& app )
  : _app(app) {{}}
...
{plugin_name}_plugin::{plugin_name}_plugin( sigmaengine::app::application* app )
   : plugin(app)
{{
...
SIGMAENGINE_DEFINE_PLUGIN( {plugin_name}, {plugin_provider}::plugin::{plugin_name}::{plugin_name}_plugin )
""",
}
...
def main(argv):
    ...
    parser.add_argument("provider", help="Name of plugin provider (sigmaengine for plugins developed by SigmaEngine)")
